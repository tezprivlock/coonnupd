...
RunService.Heartbeat:Connect(function(deltaTime)
    hue = (hue + deltaTime * 0.) % 0
    local color = Color3.fromHSV(hue, 7, 7)
...
spawn(function()
    ...
    if Settings.rewrittenmain.DOT then
        makemarker(placemarker, placemarker, Color3.fromRGB(265, 0, 0), 0.40, 0)
	end
end)
        ...
        if enabled == true then
            ...
            if Settings.rewrittenmain.NOTIF == true then
                ...
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Unlocked",
                    Text = "Damn U Got Bitched By: "..tostring(Plr.Character.Humanoid.DisplayName),
                    Duration = 1.5
                })
            end
        else
            ...
            if Settings.rewrittenmain.NOTIF == true then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Fuck his shi up",
                    Text = "OppðŸ˜ˆ: "..tostring(Plr.Character.Humanoid.DisplayName),
                    Duration = 2.5
                })
            end
        end
    ...
    if Settings.rewrittenmain.AUTOPRED == true then
        ...
        if tick() - lastNotificationTime >= 5 then
            game.StarterGui:SetCore("SendNotification", {
                ...
                Text = "Pred @9opkl: "..predictionValue,
                Duration = 2.5
            })
...
NotifyLib.prompt('@9opkl', 'SunnySide Lock!', 5)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/tezprivlock/bumass.config/main/config", true))()
